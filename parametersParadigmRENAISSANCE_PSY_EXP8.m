function parametersParadigm = parametersParadigmATWM1_PSY_EXP8()
...
parametersParadigm.nRunsPerCondition      	    = [4, 4, 4, 4];
parametersParadigm.nRunsTotal       	        = sum(parametersParadigm.nRunsPerCondition);
%parametersParadigm.wmLoad           	        = [2, 2, 2, 2];         % Set size used by Hahn et al. - BPSY - 2010
parametersParadigm.wmLoad           	        = [4, 4, 4, 4];
...
parametersParadigm.iFullRuns                    = [3, 4, 6, 7];
